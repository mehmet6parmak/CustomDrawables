...
public class MainActivity extends FragmentActivity {
	 ...
	 * memory. If this becomes too memory intensive, it may be best to switch to a {@link android.support.v13.app.FragmentStatePagerAdapter}.
	 */
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			if (position == 0) {
				return new RepeatingTransitionDrawableFragment();
			} else if (position == 1) {
				return new TransitionDrawableExtFragment();
			}
			return null;
		}
